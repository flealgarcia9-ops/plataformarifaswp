<?php
/**
 * Customer - Giveaway Multiple Winner
 *
 * @since 1.0.0
 * */
...
if ( ! class_exists( 'LTY_Customer_Lottery_Multiple_Winner_Notification' ) ) {
	...
	class LTY_Customer_Lottery_Multiple_Winner_Notification extends LTY_Notifications {
		...
		public function __construct() {
			...
			$this->type        = 'customer';
			$this->title       = __( 'Customer - Giveaway Multiple Winner', 'lottery-for-woocommerce' );
			$this->description = __( 'Send email to the giveaway multiple winners.', 'lottery-for-woocommerce' );
		...
		public function get_settings_array() {
			...
			$section_fields[] = array(
				'type'  => 'title',
				'title' => __( 'Customer - Giveaway Multiple Winner', 'lottery-for-woocommerce' ),
