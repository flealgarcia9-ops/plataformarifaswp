<?php
/**
 * Customer - Unlimited Scheduled Giveaway Instant Winner.
 *
 * @since 11.7.0
 * */
...
if ( ! class_exists( 'LTY_Customer_Unlimited_Lottery_Instant_Winner_Notification' ) ) {
	 ...
	 * @since 11.7.0
	 * */
	class LTY_Customer_Unlimited_Lottery_Instant_Winner_Notification extends LTY_Notifications {
		...
		public function __construct() {
			$this->id          = 'customer_unlimited_lottery_instant_winner';
			$this->type        = 'customer';
			$this->title       = __( 'Customer - Unlimited Scheduled Giveaway Instant Winner', 'lottery-for-woocommerce' );
		...
		public function get_default_message() {
			...
			Congratulations! You have won Instant Win Prize in you recent purchase on the {product_name}. Lottery started on {lottery_start_date}.<br/><br/>
