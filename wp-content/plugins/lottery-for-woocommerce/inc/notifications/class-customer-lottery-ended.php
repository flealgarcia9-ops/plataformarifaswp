...
if ( ! class_exists( 'LTY_Customer_Lottery_Ended_Notification' ) ) {

	/**
	 * Class LTY_Customer_Lottery_Ended_Notification.
	 * */
	class LTY_Customer_Lottery_Ended_Notification extends LTY_Notifications {
		...
		public function __construct() {
			...
			$this->id          = 'customer_lottery_ended';
			$this->type        = 'customer';
			$this->title       = __( 'Customer - Giveaway Ended', 'lottery-for-woocommerce' );
			$this->description = __( 'Send email to customer when the giveaway has ended.', 'lottery-for-woocommerce' );
...
Thanks.';
		...
		public function get_settings_array() {
			...
			// Customer Lottery ended Email Section Start.
			$section_fields[] = array(
				'type'  => 'title',
			...
			// Customer Lottery ended Email Section End.
