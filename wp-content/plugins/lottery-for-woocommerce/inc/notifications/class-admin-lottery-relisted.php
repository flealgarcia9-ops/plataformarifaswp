...
/**
 * Admin - Giveaway Relist
 * */
if ( ! defined( 'ABSPATH' ) ) {
	exit ; // Exit if accessed directly.
}

if ( ! class_exists( 'LTY_Admin_Lottery_Relisted_Notification' ) ) {

	/**
	 * Class LTY_Admin_Lottery_Relisted_Notification.
	 * */
	class LTY_Admin_Lottery_Relisted_Notification extends LTY_Notifications {

		/**
		 * Class Constructor.
		 * */
		public function __construct() {
			$this->id          = 'admin_lottery_relisted' ;
			$this->type        = 'admin' ;
			$this->title       = __( 'Admin - Giveaway Re-listed' , 'lottery-for-woocommerce' ) ;
			$this->description = __( 'Send email to admin when the giveaway has been re-listed.' , 'lottery-for-woocommerce' ) ;

			//Triggers for this email.
			add_action( sanitize_key( $this->plugin_slug . '_lottery_after_relisted' ) , array( $this, 'trigger' ) , 10 , 1 ) ;
		...
		public function get_default_message() {
			...
			return 'Hi {user_name},
The {product_name} Lottery has been re-listed successfully on {lottery_relisted_date}.
Thanks.' ;
		}
		...
		public function get_settings_array() {
			...
			// Admin Lottery relisted Email Section Start.
			$section_fields[] = array(
				'type'  => 'title',
			...
			//  Admin Lottery relisted Email Section End.
