...
if ( ! class_exists( 'LTY_Customer_Lottery_Ticket_Confirmation_Notification' ) ) {

	/**
	 * Class.
	 * */
	class LTY_Customer_Lottery_Ticket_Confirmation_Notification extends LTY_Notifications {
		...
		public function __construct() {
			$this->id          = 'customer_lottery_ticket_confirmation';
			$this->type        = 'customer';
			$this->title       = __( 'Customer - Giveaway Participation Confirmation', 'lottery-for-woocommerce' );
		...
		public function get_default_message() {
			...
			Thanks for participating in {product_name} Lottery.  Please find the details of your ticket below. The winners will be announced after {lottery_end_date}.
			{lottery_details}
			Thanks.';
		}
		...
		public function display_lottery_details( $ticket_numbers, $order_id ) {
			...
			return lty_get_template_html( 'email-shortcodes/customer-lottery-details.php', $args );
		}
