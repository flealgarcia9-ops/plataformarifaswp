<?php
/**
 * Customer - Unlimited Scheduled Giveaway Extended.
 *
 * @since 11.7.0
 * */
...
if ( ! class_exists( 'LTY_Customer_Unlimited_Lottery_Extended_Notification' ) ) {
	 ...
	 * @since 11.7.0
	 * */
	class LTY_Customer_Unlimited_Lottery_Extended_Notification extends LTY_Notifications {
		...
		public function __construct() {
			$this->id          = 'customer_unlimited_scheduled_lottery_extended';
			$this->type        = 'customer';
			$this->title       = __( 'Customer - Unlimited Scheduled Giveaway Extend', 'lottery-for-woocommerce' );
		...
		public function is_valid( $product ) {
			return lty_is_lottery_product( $product ) && $product->is_unlimited_scheduled_lottery();
		}
