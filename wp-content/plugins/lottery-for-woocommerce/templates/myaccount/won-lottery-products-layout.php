<?php
/**
 * This template is used for displaying the myaccount won lottery products layout.
 *
 * This template can be overridden by copying it to yourtheme/lottery-for-woocommerce/myaccount/won-lottery-products-layout.php
 *
 * To maintain compatibility, Giveaway(formerly Lottery) For WooCommerce will update the template files and you have to copy the updated files to your theme
 *
 * @since 9.1.0
 * @var array $columns Column names.
 * @var array $post_ids Winner IDs.
...
<div class='lty-myaccount-won-lottery-products-wrapper lty-data-table-wrapper'>
	<?php
	...
	<table class="lty-frontend-table lty-myaccount-lottery-<?php echo esc_attr( str_replace( '_', '-', $current_lottery_menu ) ); ?>">
		...
		<tbody>
			<?php
			lty_get_template(
				'myaccount/won-lottery-products.php',
				array(
					'columns'              => $columns,
					'winner_ids'           => $post_ids,
		...
		<?php if ( $pagination['page_count'] > 1 ) : ?>
			<tfoot>
				<tr>
					<td colspan="<?php echo esc_attr( count( $columns ) ); ?>" class='footable-visible actions' data-action_name='lty_myaccount_lottery_won_lottery_products'>
