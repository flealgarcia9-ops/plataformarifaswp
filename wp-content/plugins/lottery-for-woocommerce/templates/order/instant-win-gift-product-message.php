<?php
/**
 * This template is used for displaying the lottery instant win gift product message on order details page.
 *
...
<div class='lty-instant-win-gift-product-message-wrapper'>
	<span class='lty-instant-win-gift-product-message lty-order-details-page-instant-win-gift-product-message'>
