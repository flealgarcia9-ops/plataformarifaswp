 ...
 *
 * This template can be overridden by copying it to yourtheme/lottery-for-woocommerce/order/instant-winners-layout.php
 *
...
<div class='lty-order-instant-winners-wrapper'>
	...
	<table class='lty-data-table-wrapper lty-order-details-page-instant-winners'>
		<thead>
			<tr>
		...
		<?php if ( $pagination['page_count'] > 1 ) : ?>
			<tfoot>
				<tr>
					<td colspan="<?php echo esc_attr( count( $columns ) ); ?>" class='footable-visible lty-pagination-wrapper' data-action_name='lty_order_instant_winners' data-extra_data='<?php echo wp_json_encode( array( 'order_id' => $order_id, 'template' => 'order' ) ); ?>'>
