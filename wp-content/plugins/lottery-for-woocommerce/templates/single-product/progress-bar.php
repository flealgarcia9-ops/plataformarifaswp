 ...
 *
 * This template can be overridden by copying it to yourtheme/lottery-for-woocommerce/single-product/progress-bar.php
 *
...
?>
<div class='lty-lottery-progress-bar'>
	<div class='lty-progress-count'>
	...
	<?php if ( 'yes' === get_option( 'lty_settings_display_progress_bar_percentage_product_page' ) && '1' === get_option( 'lty_settings_progress_bar_percentage_display_type_product_page', '1' ) ) : ?>
	...
	<div class='lty-progress-bar'>
		<span style="width:<?php echo esc_attr( $progress_bar_percentage ); ?>%;clear: both;"> 
			<span class='lty-progress-fill'>
				<?php if ( '2' === get_option( 'lty_settings_progress_bar_percentage_display_type_product_page', '1' ) ) : ?>
				<span class='lty-inner-percentage' style="left:calc(<?php echo esc_attr( $progress_bar_percentage > 93 ? 93 : $progress_bar_percentage ); ?>% + 5px);" ><?php echo esc_attr( $progress_bar_percentage ); ?>%</span>
				<?php endif; ?>
			</span>
		</span>
	</div>
