 ...
 *
 * This template can be overridden by copying it to yourtheme/lottery-for-woocommerce/dashboard/not-won-lottery-products-layout.php
 *
...
?>
<div class="lty-not-won-lottery-products-wrapper lty-data-table-wrapper">
	<table class = "lty-frontend-table lty-dashboard-<?php echo esc_attr(str_replace('_', '-', $current_lottery_menu)); ?>">
		...
		<tbody>
			<?php
			lty_get_template('dashboard/not-won-lottery-products.php', array(
				'columns' => $columns,
				'post_ids' => $post_ids,
		...
		<?php if ($pagination['page_count'] > 1) : ?>
			<tfoot>
				<tr>
					<td colspan="<?php echo esc_attr(count($columns)); ?>" class="footable-visible" data-action_name="lty_not_won_lottery_products">
